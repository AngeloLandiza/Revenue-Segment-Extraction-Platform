    ...
    def from_env(cls) -> "PageTextFallbackSettings":
        return cls(
            enabled=_bool_from_env(
                "FITCH_ENABLE_PAGE_TEXT_FALLBACK",
                DEFAULT_ENABLE_PAGE_TEXT_FALLBACK,
            ),
            provider_name=os.getenv(
                "FITCH_PAGE_TEXT_FALLBACK_PROVIDER",
                DEFAULT_PAGE_TEXT_FALLBACK_PROVIDER,
            ),
            ocr_command=os.getenv("FITCH_OCR_COMMAND", DEFAULT_OCR_COMMAND),
            ocr_languages=os.getenv("FITCH_OCR_LANGUAGES", DEFAULT_OCR_LANGUAGES),
        )
