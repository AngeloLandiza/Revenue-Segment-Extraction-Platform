...
def build_candidate_discovery_prompt(
    *,
    ...
    from revenue_segment_extractor.extraction.schemas import CandidateDiscoveryOutput
    ...
    *,
    ...
    return "\n".join(
        [
            ...
            "- Translate explanatory notes only when needed and never replace an official segment label with a translated-only label.",
            "- Apply the same revenue segment extraction rules: revenue/net sales/turnover/revenue-equivalent segment metrics only; no expenses, assets, losses, profit, EBIT, EBITDA, or tax rows.",
    ...
    *,
    ...
    return "\n".join(
        [
            ...
            "",
            "You extract ESG factors from annual reports and 10-K filings for a revenue-segment prototype.",
            "Return valid JSON only. Do not wrap the JSON in Markdown.",
            "",
            "Core ESG rules:",
